...
class AlphaVantageIndicatorsProvider(AlphaVantageBaseProvider):
    """
    ...
    ALL_INDICATORS = {
        ...
        "macds": {"name": "MACD Signal", "description": "MACD signal line", "usage": "Trigger line", "tips": "Crossovers = buy/sell signals"},
        "macdh": {"name": "MACD Histogram", "description": "MACD minus signal line", "usage": "Momentum strength", "tips": "Growing bars = stronger momentum"},
        "rsi": {"name": "RSI", "description": "Relative Strength Index", "usage": "Overbought/oversold", "tips": ">70 overbought, <30 oversold"},
        "boll": {"name": "Bollinger Middle", "description": "Bollinger middle band", "usage": "Mean reversion", "tips": "Price returns to middle"},
        "boll_ub": {"name": "Bollinger Upper", "description": "Bollinger upper band", "usage": "Resistance", "tips": "Touch = overbought"},
        "boll_lb": {"name": "Bollinger Lower", "description": "Bollinger lower band", "usage": "Support", "tips": "Touch = oversold"},
        "atr": {"name": "ATR", "description": "Average True Range", "usage": "Volatility", "tips": "Higher = more volatile"},
    }
