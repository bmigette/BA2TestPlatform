...
class PandasIndicatorCalc:
    ...
    ALL_INDICATORS = {
        "close_50_sma": {"name": "50-Day SMA", "description": "50-period simple moving average", "usage": "Trend identification", "tips": "Price above SMA = bullish"},
        "close_200_sma": {"name": "200-Day SMA", "description": "200-period simple moving average", "usage": "Long-term trend", "tips": "Golden cross = bullish signal"},
        "close_10_ema": {"name": "10-Day EMA", "description": "10-period exponential moving average", "usage": "Short-term trend", "tips": "Faster response to price changes"},
        "macd": {"name": "MACD", "description": "Moving Average Convergence Divergence", "usage": "Momentum and trend", "tips": "MACD crossing signal line = trend change"},
        "macds": {"name": "MACD Signal", "description": "MACD signal line (9-period EMA of MACD)", "usage": "Trigger line for MACD", "tips": "Crossovers indicate buy/sell signals"},
        "macdh": {"name": "MACD Histogram", "description": "Difference between MACD and signal line", "usage": "Momentum strength", "tips": "Growing bars = strengthening momentum"},
        "rsi": {"name": "RSI", "description": "Relative Strength Index (14-period)", "usage": "Overbought/oversold", "tips": "Above 70 = overbought, below 30 = oversold"},
        "boll": {"name": "Bollinger Middle", "description": "Bollinger Bands middle line (20-SMA)", "usage": "Mean reversion", "tips": "Price tends to return to middle band"},
        "boll_ub": {"name": "Bollinger Upper", "description": "Bollinger Bands upper band", "usage": "Resistance level", "tips": "Touch may indicate overbought"},
        "boll_lb": {"name": "Bollinger Lower", "description": "Bollinger Bands lower band", "usage": "Support level", "tips": "Touch may indicate oversold"},
        "atr": {"name": "ATR", "description": "Average True Range", "usage": "Volatility measurement", "tips": "Higher ATR = more volatility"},
        "vwma": {"name": "VWMA", "description": "Volume Weighted Moving Average", "usage": "Volume-adjusted price", "tips": "More accurate than simple MA"},
        "mfi": {"name": "MFI", "description": "Money Flow Index", "usage": "Volume-weighted RSI", "tips": "Above 80 = overbought, below 20 = oversold"},
    }

    # Indicators supported by this provider
    ...
    def get_indicator(
        ...
        try:
            ...
            ind_meta = self.ALL_INDICATORS[indicator]
