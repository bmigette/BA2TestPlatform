...
from .types import MarketDataPoint
from .DataProviderInterface import DataProviderInterface
from dataproviders.utils import log_provider_call, validate_date_range

logger = logging.getLogger(__name__)

# Cache folder configuration - use environment variable or default
CACHE_FOLDER = os.getenv("CACHE_FOLDER", os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "cache"))
...
class MarketDataProviderInterface(DataProviderInterface):
    ...
    def __init__(self):
        ...
        """
        # Use CACHE_FOLDER + class name for provider-specific subfolder
    ...
    def get_ohlcv_data_formatted(
        ...
        """
        from dataproviders.utils import calculate_date_range, validate_date_range
