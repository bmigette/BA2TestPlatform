...
DB schema lifecycle adds it via ``db_migrate/014_add_screener_history.py``. The DDL here
...
# Kept byte-identical to db_migrate/014_add_screener_history.py so the standalone
