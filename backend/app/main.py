...
async def startup_event():
    ...
    from app.services.news_cache_handler import handle_news_cache_fetch
    ...
    task_queue.register_handler('news_cache_fetch', handle_news_cache_fetch)
    logger.info("Registered task handlers: dataset_regeneration, training_job, backtest, ohlcv_cache_fetch, news_cache_fetch")
